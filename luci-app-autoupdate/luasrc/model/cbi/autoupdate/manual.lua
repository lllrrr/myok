...
check_updates.write = function()
	luci.sys.call ("wget -P /tmp/tmp --timeout=50 http://$(uci -q get autoupdate.@autoupdate[0].github)/fw/$(uci -q get autoupdate.@autoupdate[0].flag).bin 2>> /tmp/autoupdate.log")
	luci.sys.call ("wget -P /tmp/tmp --timeout=3 http://$(uci -q get autoupdate.@autoupdate[0].github)/fw/$(uci -q get autoupdate.@autoupdate[0].flag) 2>> /tmp/autoupdate.log")
...
upgrade_fw.write = function()
	luci.sys.call ("sysupgrade -n -q /tmp/tmp/$(uci -q get autoupdate.@autoupdate[0].flag).bin 2>> /tmp/autoupdate.log")
	luci.http.redirect(luci.dispatcher.build_url("admin", "services", "autoupdate","log"))
end
...
upgrade_config.write = function()
	luci.sys.call ("wget -P /tmp/tmp --timeout=3 http://$(uci -q get autoupdate.@autoupdate[0].github)/config/$(uci -q get autoupdate.@autoupdate[0].configf) 2>> /tmp/autoupdate.log")
...
upgrade_script.write = function()
	luci.sys.call ("wget -P /tmp/tmp --timeout=3 http://$(uci -q get autoupdate.@autoupdate[0].github)/script/$(uci -q get autoupdate.@autoupdate[0].scriptf) 2>> /tmp/autoupdate.log")
