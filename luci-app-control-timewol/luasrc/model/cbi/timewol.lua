...
t = Map("timewol", translate("定时网络设备唤醒"), translate("<b>利用“计划任务”来定时唤醒局域网中的设备的工具。时间点设置可参考<input class=\"cbi-button cbi-button-apply\" type=\"submit\" value=\" "..translate("“定时设置”").." \" onclick=\"window.open('http://'+window.location.hostname+'/cgi-bin/luci/admin/control/rebootschedule')\"/>中的说明。</b>") .. button .. "<br/><br/>" .. translate("运行状态").. " : "  .. state_msg .. "<br />")
