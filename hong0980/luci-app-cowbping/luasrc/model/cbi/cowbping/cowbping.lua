...
m.description = translate("<font style='color:black'>定期ping一个网站以检测网络是否通畅，否则执行相关动作以排除故障。网站一与网站二是“与”关系，丢包率与延迟是“或”关系。</font>" .. "<br><br>" .. translate("运行状态：" ) .. state_msg .. "<br>")

s = m:section(NamedSection, "cowbping")
s.anonymous=true
s.addremove=false

enabled = s:option(Flag, "enabled", translate("启用"), translate("<b><font color=\"red\">请先配置好所有项目、保存并应用后再启用。</font></b>"))
enabled.default = 0
...
enabled:value("4", translate("4.重启网络"))
enabled:value("7", translate("5.关机睡觉"))
enabled:value("5", translate("6.shell命令"))
-- enabled:value("6", translate("7.自动中继"))
enabled.default = 2

command = s:option(TextValue, "/etc/config/cbp_cmd", translate("shell脚本："), translate("* 应用前需仔细检查脚本语法，如存在语法错误会导致所有命令无法执行，可终端执行bash -n /etc/config/cbp_cmd检查。"))
